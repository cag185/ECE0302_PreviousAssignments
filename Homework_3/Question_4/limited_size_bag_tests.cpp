...
//defualt
TEST_CASE("DEFUALT CONSTRUCTOR", "[LimitedSizeBag]")
{
  LimitedSizeBag<int> b; // create bag
...
TEST_CASE("COPY CONSTRUCTOR", "[LimitedSizeBag]"){
  LimitedSizeBag<int> a; // create bag
  a.add(100);
  a.add(20);

  //copy the first constructor into the second
  LimitedSizeBag<int> b(a); //creates a copy
...
TEST_CASE("Add function", "[LimitedSizeBag]"){
  LimitedSizeBag<int> b; // create bag
...
//remove
TEST_CASE("Remove function", "[LimitedSizeBag]")
{
  LimitedSizeBag<int> a;
  a.add(1);
  a.add(57);
...
//isEmpty
TEST_CASE("Empty function", "[LimitedSizeBag]")
{
  LimitedSizeBag<int> a;
  a.add(1);
  REQUIRE(a.getCurrentSize() == 1);
...
//getCurrentSize
TEST_CASE("getCurrentSize function", "[LimitedSizeBag]")
{
  LimitedSizeBag<int> b;
  b.add(1);
  b.add(2);
...
//getFrequency
//clear
TEST_CASE("getFrequency", "[LimitedSizeBag]")
{
  LimitedSizeBag<int> a;
  a.add(1);
  a.add(4);
...
//Contains
//clear
TEST_CASE("Contains", "[LimitedSizeBag]")
{
  LimitedSizeBag<double> a;
  a.add(1.0);
  a.add(4.5);
  a.add(5.1);
  REQUIRE(a.getCurrentSize() == 3);
